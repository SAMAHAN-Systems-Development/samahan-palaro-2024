      ...
      <nav className="jersey10 bg-blue shadow-lg border-b-8 border-green">
        <div className="w-full mx-auto flex justify-between p-4">
          <div className="flex items-center">
            ...
            <Link href="/">
              <img src={logo.src} alt="Palaro Logo" className="h-8 mr-500" />
            </Link>
          </div>

          <ul
            className={`flex flex-col lg:flex-row items-center lg:space-x-8 space-y-4 lg:space-y-0 py-4 font-jersey10 ${
              isMenuOpen ? 'absolute top-[100px] left-0 w-full bg-blue shadow-lg' : 'hidden lg:flex lg:justify-end'
            }`}
          >
